...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.icons = {
		    leftArrow: this.fontAwesome ? 'fa fa-arrow-left' : (this.bootcssVer === 3 ? 'glyphicon-arrow-left' : 'fa fa-arrow-left'),
		    rightArrow: this.fontAwesome ? 'fa fa-arrow-right' : (this.bootcssVer === 3 ? 'glyphicon-arrow-right' : 'fa fa-arrow-right')
		};
...
if(!!$("").formValidation){
$("form:not(#pageform)").formValidation('revalidateField', this.element.find('input').attr("name"));
}
				}
...
if(!!$("").formValidation){
$("form:not(#pageform)").formValidation('revalidateField', this.element.attr("name"));
}
			}
			if (this.linkField) {
